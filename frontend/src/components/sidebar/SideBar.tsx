...
import { CurrentData } from './searchbar/CurrentData'
...
export default function SideBar({journals}:Props) {
    ...
    const [current_variable_controls, setCurrentVariableControls] = useState<VariableName>()
    return (
        <div >
            <div className="absolute top-0 left-0 ml-5 h-full">   
                <SearchButton search_bar_visible={search_bar_visible} setSearchBarVisible={setSearchBarVisible}/>
                <Variables setCurrentDataDetails = {setCurrentDataDetails}
            ...
            <div className='absolute top-0 py-2 left-28 w-5/12'>
                <CurrentData display_details={current_data_details} 
                    setCurrentVariableControls = {setCurrentVariableControls}
                    setDisplayDetails={setCurrentDataDetails} 
                    search_bar_visible = {search_bar_visible}></CurrentData>
            </div>
