...
import { TimeState, TimeID, CollectionID, WorldData, Slots, TimeConf } from "./time.type"
...
export interface TimeSlice {
  time: {
    ...
    addAll: (collection: {publication:Publication,exp_id:string}[],config?:Partial<TimeConf>) => void
    clear : () => void
